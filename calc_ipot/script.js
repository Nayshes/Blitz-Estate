...
const CREDIT_MAX = 150000000 // максимально возможный кредит
const CREDIT_DEFAULT = 12000000

const CONTRIBUTION_MIN = 700000 // минимально возможный Первоначальный взнос
const CONTRIBUTION_MAX = 20000000 // максимально возможный Первоначальный взнос
...
const PERCENT_NUMBER_MIN = 2
    // Максимально возможная процентная ставка.
const PERCENT_NUMBER_MAX = 10
